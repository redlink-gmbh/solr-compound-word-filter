...
public class ResourceCache {
    ...
    private final LoadingCache<ResourceRef<?,?>, Object> resources = CacheBuilder.newBuilder()
            ...
            .weakValues() 
            .build(
                new CacheLoader<ResourceRef<?,?>, Object>() {
                  public Object load(ResourceRef<?,?> ref) throws IOException {
                    return loadResource(ref);
                  }
                });
    ...
    public static abstract class ResourceTypeLoader<K,R>{
